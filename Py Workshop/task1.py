...
if door =="1":
	...
	if vampire =="1":
		...
		print("Sorry %s, the vampire was faster. You became dinner." % (name))
	else:
	...
	if werewolf =="1":
		...
		print("Sorry %s, the werewolf's feeling got hurt and you became dinner." % (name))
	else:
		print("You are not good with numbers %s, are you?" % (name))
	print()
	...
	if witch =="1":
		print("You jumped with a broom out of a window and died. Oops.")
	elif witch =="2":
		print("Congratulations!You managed to run away from an old woman.")
	else:
		print("You are not good with numbers, are you?")
	print()
